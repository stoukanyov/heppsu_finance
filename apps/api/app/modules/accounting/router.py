...
# ---------- Сметкоплан ----------
@router.post("/chart/seed", response_model=list[AccountOut], status_code=status.HTTP_201_CREATED)
...
@router.patch("/periods/{period_id}/status", response_model=PeriodOut)
