...
# Прагът беше 3 000 000 лв. С приемането на еврото от 01.01.2026 законовите прагове
# са ПРЕДЕФИНИРАНИ в закона, а не преизчислени по курса — 3 000 000 / 1,95583 почти
# сигурно не е числото в ЗКПО. Докато точната стойност не се потвърди от текста на
# закона, бележката сочи разпоредбата вместо да твърди сума.
_NOTE_CIT_MONTHLY = (
    "ако нетните приходи от продажби за предходната година надхвърлят прага "
    "по чл. 83, ал. 2 ЗКПО"
)
