...
@router.post("/accounts/{account_id}/import", response_model=ImportResult, status_code=status.HTTP_201_CREATED)
...
@router.post("/accounts/{account_id}/import-csv", response_model=ImportResult, status_code=status.HTTP_201_CREATED)
...
@router.post("/accounts/{account_id}/import-mt940", response_model=ImportResult, status_code=status.HTTP_201_CREATED)
...
@router.post("/accounts/{account_id}/import-camt", response_model=ImportResult, status_code=status.HTTP_201_CREATED)
...
@router.get("/transactions/{tx_id}", response_model=BankTransactionOut)
...
# ---------- Съгласуване ----------
@router.post("/transactions/{tx_id}/suggest-matches", response_model=list[MatchSuggestion])
...
@router.post("/transactions/{tx_id}/match", response_model=MatchOut, status_code=status.HTTP_201_CREATED)
...
@router.delete("/transactions/{tx_id}/matches/{match_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.post("/transactions/{tx_id}/ignore", response_model=BankTransactionOut)
