...
@router.get("/{pid}", response_model=PaymentOut)
...
@router.post("/{pid}/approve", response_model=PaymentOut)
...
@router.post("/{pid}/reject", response_model=PaymentOut)
...
@router.post("/{pid}/cancel", response_model=PaymentOut)
